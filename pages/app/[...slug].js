        ...
        <div className="sidebar">
          <div className="sidebar-header">
            <div className="sidebar-top">
              <span className="sidebar-title">록근_v75</span>
            ...
            <div className="task-detail" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
              ...
              {mmDateSummary && (
                <div style={{ marginBottom: '10px', padding: '12px', borderRadius: '8px', background: 'var(--accent-bg, #e8f0fe)', border: '1px solid var(--accent, #0066cc)', flexShrink: 0 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '6px', marginBottom: mmDateSummaryCollapsed ? 0 : '6px' }}>
                    <span style={{ fontWeight: 700, fontSize: '13px', flex: 1, minWidth: 0 }}>📅 {mmDateInput.replace(/(\d{4})-(\d{2})-(\d{2})/, '$1년 $2월 $3일')} 요약</span>
